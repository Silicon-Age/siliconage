...
//	private static final String USER_FACING_SUFFIX = "UserFacing";
//	private static final String FACTORY_SUFFIX = "Factory";
//	private static final String OPAL_SUFFIX = "Opal";
//	private static final String IMPLEMENTATION_SUFFIX = "Impl";
//	private static final String MONE_PREFIX = "Mone";
	
//	private static final String MONE_SUBPACKAGE_NAME = "mone";
...
//	private List<ClassGenerator> mySubclasses = new ArrayList<>();
//	
	...
	protected void createUserFacing() throws IOException {
		...
		try (PrintWriter lclBW = new PrintWriter(new BufferedWriter(new FileWriter(lclUserFacingClassFile)))) {
			...
			if (lclOrderingMember != null) {
				lclBW.print(", Comparable<" + lclMC.getFullyQualifiedInterfaceClassName() + '>');
			}
...
//			return false;
//		}
//		ClassGenerator lclRootSuperclass = getRootSuperclass();
...
//						ClassGenerator lclMC = lclMFK.getTargetMappedClass();
...
//	}
//	
//	public List<ClassGenerator> getSubclasses() {
//		return mySubclasses;
//	}
//	
...
//		MappedForeignKey lclSK = lclMC.getSuperclassKey();
//		if (lclSK == null) {
//			if (lclMC.getPolymorphicData() != null && lclMC.getPolymorphicData() instanceof SubtablePolymorphicData) {
//				return lclMC;
//			} else {
//				return null;
//			}
...
//				ClassGenerator lclRootSupertable = null;
//				while (lclSK2 != null) {
...
//		
//		ClassGenerator lclCurrentClass = this;
//		
//		MethodLoop:
...
//		Validate.isTrue(lclSPD.getDereferenceKeys().size() == lclNames.size());
//		
//		ClassGenerator lclMC = getSuperclass();
//		if (lclMC != null) {
