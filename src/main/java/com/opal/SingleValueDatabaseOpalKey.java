...
public abstract /* value */ class SingleValueDatabaseOpalKey<O extends IdentityOpal<? extends IdentityUserFacing>> extends SingleValueOpalKey<O> implements DatabaseOpalKey<O> { // OPALFIXME
