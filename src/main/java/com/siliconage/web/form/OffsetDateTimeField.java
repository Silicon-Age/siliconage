...
public class OffsetDateTimeField<T extends OffsetDateTimeField<?>> extends TextBasedHTMLInputField<T, OffsetDateTime> {
	...
	public OffsetDateTimeField(String argName, OffsetDateTime argSavedValue, FormValueProvider argEnteredValueProvider) {
		super(argName, argSavedValue, argEnteredValueProvider);
		
		defaultFormat();
	}
	
	public OffsetDateTimeField(String argName, OffsetDateTime argValue) {
		super(argName, argValue);
		
		defaultFormat();
	}
	
	public OffsetDateTimeField(String argName) {
		this(argName, null);
	}
	...
	protected String getInputType() {
		return "text"; // CHECK: eventually change to datetime
	}
	...
	protected String fieldTypeSpecificAttributes() {
		return super.fieldTypeSpecificAttributes() + outputAttribute("data-content-type", "datetime") + outputAttribute("pattern", getRegularExpression());
	}
	
	@Override
	public String getSavedValueAsString() {
		if (isRealField()) {
			OffsetDateTime lclSaved = getSavedValue();
